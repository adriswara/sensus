...
<body>
    <div class="ml-52 mr-96 mt-32 mb-60">
        ...
        <form class="form-group" method="POST" action="update_artikel.php">
            <?php
            ...
            <input id="judul_artikel" class=" mb-5 form-control" style="border-width: 1px; border-color: black;" type="text" name="judul_artikel"
            ...
            <textarea class="form-control" style="border-width: 1px; border-color: black;" name="isi_artikel" rows="4" cols="50"
                value="<?= $data['isi_artikel']; ?>"> <?= $data['isi_artikel']; ?> </textarea>
            <br>
